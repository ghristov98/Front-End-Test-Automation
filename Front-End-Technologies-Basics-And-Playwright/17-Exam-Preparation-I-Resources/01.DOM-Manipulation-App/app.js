...
function solve() {
    ...
    const purchaseNumTicketsElement = document.getElementById("purchase-num-tickets");
    ...
    function onAdd(e) {
        ...
        purchaseNumTicketsElement.textContent = ticketsNumElement.value
    ...
    function onEdit() {
        ticketsNumElement.value = purchaseNumTicketsElement.textContent;
